...
<div class="bg-blue-50 min-h-screen py-10 px-4">
    ...
    <div class="text-center mb-10">
        ...
        <h1 class="text-2xl font-bold text-blue-700">Modifier une filière</h1>
    </div>

    <!-- Formulaire de création -->
    <div class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
        <form action="{{ route('administrateurs.filieres.update', $filiere->id) }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="abbreviation" id="abbreviation" value="{{ $filiere->abreviation }}"
            ...
            <div>
                ...
                <input type="text" name="nom_complet" id="nom_complet" value="{{ $filiere->nom_complet }}"
                       class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"

...
<div class="bg-blue-50 min-h-screen py-10 px-4">
    ...
    <div class="text-center mb-10">
        ...
        <h1 class="text-2xl font-bold text-blue-700">Ajouter un fonctionnaire</h1>
    </div>
    ...
    <div class="bg-blue-50 flex items-center justify-center min-h-screen">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST" action="{{ route('administrateurs.fonctionnaires.store') }}">
                @csrf
